...
import { addSmurf, setErrorMsg } from "../actions/index";

const AddForm = ({ error, addSmurf, setErrorMsg }) => {
...
export default connect(mapStateToProps, { addSmurf, setErrorMsg })(AddForm);
